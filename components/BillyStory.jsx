      ...
      >
        ...
        <div className="text-center max-w-2xl z-10">
          ...
          >
            ...
            <div className="mt-6">
              <a 
                href="https://github.com/theKageEth/OctoBilly" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gray-800/50 backdrop-blur rounded-full text-white font-medium hover:bg-gray-700/50 transition-colors"
              >
                <svg 
                  width="20" 
                  height="20" 
